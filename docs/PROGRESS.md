...
当前步骤：M6 人工验收反馈——popup、飞书、钉钉、Telegram、Slack 已完成真机验收；Codex Permission Hook
trust 漏算 `statusMessage` 已修复并经 Codex 0.144.1 官方 `hooks/list` 与重启实测确认 trusted，正在提交收尾。
